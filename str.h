...
//struct of syscolumns
typedef struct {
	char tableName[21]; //table name
	char attrName[21];  //attribute name
	int  attrType;      //attribute type
	int  attrLength;    //attribute lenght
	int  attrOffset;    //the offset of attribute in a record
	char ix_flag;       //index  '1' or no index '0'
